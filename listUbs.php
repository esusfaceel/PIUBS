...
<div class="row">
	<div class="col s12 m10 offset-m1 l8 offset-l2">
		<div class="card white darken-1">
			<div class="card-content">
				<span class="card-title center">UBS</span>
    ...
    if ($controller->getSession('login')->getIdCargo() == Security::ADM) {
        foreach ($controller->getAll() as $ubs) {
            echo "<tr><td>" . $ubs->getId() . "</td><td>" . $ubs->getNome() . "</td><td><a href='detailUbs/" . $ubs->getId() . "'><i class='material-icons'>search</i></a></td><td><a href='editUbs/" . $ubs->getId() . "'><i class='material-icons'>edit</i></a></td></tr>";
        }
    } else {
        foreach ($controller->getAll() as $ubs) {
            echo "<tr><td>" . $ubs->getId() . "</td><td>" . $ubs->getNome() . "</td><td><a href='detailUbs/" . $ubs->getId() . "'><i class='material-icons'>search</i></a></td><td></td></tr>";
        }
    }
    ?>
								</tbody>
